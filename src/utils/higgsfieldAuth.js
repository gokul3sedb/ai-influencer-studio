...
// Opens ONE popup on about:blank, then navigates it to the Higgsfield OAuth URL
// once that URL is built. No extra tabs ever.
export async function startHiggsfieldOAuthPopup() {
  ...
  // We open a blank popup and redirect it once the auth URL is ready.
  ...
  // Send the blank popup straight to OAuth.
